...
**Identidad** (`vault/ceo/identidad-max.md`): Max · Estratega Digital 5.0, muñequito 3D (pin de brújula, brillo
amarillo LU) en `public/marcas/max/`; publica en Slack con su nombre y foto (`chat:write.customize`), sus mensajes
