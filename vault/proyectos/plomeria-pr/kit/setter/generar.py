...
<li>Un "no" es un no: una sola vez ofreces el diagnóstico; si no quiere, das las gracias y cierras.</li></ul>
...
<table><tr><td>Visita de diagnóstico (${DIAG})</td><td class="n">$5</td></tr><tr><td>Trabajo pequeño (destape, inodoro, llave…)</td><td class="n">$10</td></tr>
<tr><td>Trabajo mediano (calentador, bomba, filtración…)</td><td class="n">$20</td></tr><tr><td>Trabajo grande cotizado en sitio</td><td class="n">5 % de la mano de obra (mín. $20, tope $75)</td></tr>
...
<tr><td>Arranque: primeras 4 semanas, mínimo garantizado</td><td class="n">$75/semana (tope $300)</td></tr></table>
<p><small>Cuenta si el cliente vino de un aviso tuyo o de tu llamada, agendó dentro de 7 días y el trabajo se cobró.</small></p>

<h2>8. Primer día</h2>
<ol><li>Aure te agrega al grupo de Telegram "Resuelto · Ventas".</li><li>Se desvía el 787-956-1111 a tu celular (lunes a sábado, 8 AM a 7 PM).</li>
