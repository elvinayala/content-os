...
export const PILARES: Record<Pilar, { que: string; angulos: string[] }> = {
  ...
  producto: {
    que: "Resuelto como producto: precio fijo antes de ir, plomero licenciado, ventana de 2 horas, garantía de 12 meses por escrito, cotiza y agenda por WhatsApp. Y para plomeros: 65% de la mano de obra, pago los viernes, $0 publicidad, buscamos plomeros en TODO Puerto Rico. CTA directo al WhatsApp 939-247-9234 o resueltopr.com.",
    angulos: ["menú de precios: destape desde $149, precio antes de ir", "así funciona: escribes, te damos precio, agendamos, va un licenciado, pagas al final", "garantía de 12 meses por escrito", "plomeros: gana con nosotros — 65%, pago los viernes, toda la isla", "sin sorpresas en la factura", "atendemos por WhatsApp en minutos"],
  },
  mentalidad: {
