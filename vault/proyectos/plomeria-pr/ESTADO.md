...
| **Meta · portafolio Resuelto Home Services LLC** (18/sep) | business `157965986805918` · cuenta publicitaria `act_1564735818086768` (AST, USD) · página Resuelto PR `1278171838721301` · pixel `28140823722265213` en las 3 landings (PageView · Lead · Contact) · **2 campañas en borrador, $65/día total, presupuesto por conjunto:** Leads · Sprint 1 (L1 video con audio $18 + L2 flyer $12, Advantage+ PR 25+, conversión Lead web) y WhatsApp · Sprint 1 (W1 video con audio $21 + W2 flyer $14, Hombres 30+, intereses plomería). IDs en `agente/.env` y detalle en `campana-ads-reclutamiento.md` | ✅ falta: método de pago (Elvin) · número de WhatsApp en W1/W2 · Instagram (login) |
