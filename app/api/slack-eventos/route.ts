...
const IDENTIDAD_MAX: Identidad = { username: process.env.MAX_NOMBRE_SLACK || "Max · Estratega Level Up", icon_url: process.env.MAX_AVATAR_URL || `${ORIGEN}/marcas/max/max-avatar-v2-512.png` };
