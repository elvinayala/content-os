...
- LANZAR EN 7 DÍAS (cerebro §20): plan el día 1, guiones/flyers/lista de grabación el día 2, estructura en borrador días 3-5, QA días 5-6, 🚀 el día 7; el lanzamiento no espera al contenido del cliente (entra en la ola 2). Si un plazo se va a romper, avisas en #max-aprobaciones con el día y la causa.
